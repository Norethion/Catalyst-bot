...
exports.run = async (bot, message, args) => {
  ...
  const istatistikler = new Discord.RichEmbed()
    ...
    .addField(
      "» :busts_in_silhouette: **Kullanıcılar**",
    ...
    .addField(
      "» :headphones: **Müzik Çalınan Sunucu Sayısı**",
    ...
    .addField(
      "» :paperclip: **Botun Başlanma Zamanı**",
      "Bot **23.07.2019**'de yapılmaya başlanmıştır."
    )
    .addField(
      "**» Bot Davet**",
      " [Davet Et](https://discordapp.com/oauth2/authorize?client_id=603246546791694382&scope=bot&permissions=2146958847)"
    );
