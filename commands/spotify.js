...
module.exports.run = async (bot, message, args) => {
  ...
  if (!args[0])
    return message.channel.send(
      "**Şarkı bilgisini bulmam için Spotify'dan şarkı dinleyen birisini etiketlemen lazım.**"
    );
    ...
    try {
      ...
      const embed = new Discord.RichEmbed()
        ...
        .setFooter(
          ...
          "https://cdn.discordapp.com/emojis/515260605347659777.png?v=1"
        )
        .setDescription(
          `
...
`
        ...
        .addField(
          "Spotify'da Dinlediği Şarkı Linki;",
          `**[${trackUrl}](${trackUrl})**`,
          false
        );
      ...
      return message.channel.send(
        ` **${user.tag}** kullanıcısı şuanda **Spotify**<:spotify:515260605347659777>'dan şarkı dinlemiyor.`
      );
    }
  } else {
    return message.channel.send(
      `**${user.tag}** kullanıcısı şuanda Discord'una **Spotify**<:spotify:515260605347659777>'ı eklememiş`
    );
  }
};
...
exports.help = {
  name: "spotify",
  description:
    "Herhangi bir kişinin spotify da dinlediği müziği detaylı olarak gösterir.",
  usage: "spotify"
};
